...
class TestPRUpsert:
    ...
    def test_it_raises_if_the_base_and_head_branch_are_the_same(self):
        pass

    def test_if_there_are_no_changes_it_closes_any_existing_pr(self):
        pass

    def test_it_doesnt_close_prs_that_have_other_contributors(self):
        pass

    def test_if_the_remote_branch_doesnt_exist_it_creates_it(self):
        pass

    def test_if_the_remote_branch_already_exists_it_updates_it(self):
        pass

    def test_it_doesnt_push_the_remote_branch_if_there_are_other_contributors(self):
        pass

    def test_it_doesnt_push_the_remote_branch_if_the_changes_are_the_same(self):
        pass

    def test_if_the_pr_doesnt_exist_it_creates_one(self):
        pass
