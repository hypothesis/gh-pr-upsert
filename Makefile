...
coverage: python
	@pyenv exec tox --parallel -qe 'tests,py{39}-tests,coverage'
...
sure: python
sure:
	@pyenv exec tox --parallel -qe 'checkformatting,lint,typecheck,tests,py{39}-tests,coverage,functests,py{39}-functests'
